...
typedef struct
{
    volatile U32 FSEL[6];          ///< GPIO Function Select
    U32 _x_reserved1[1];
    volatile U32 SET[2];           ///< GPIO Pin Output Set
    U32 _x_reserved2[1];
    volatile U32 CLR[2];           ///< GPIO Pin Clear
    U32 _x_reserved3[1];
    volatile U32 LEV[2];           ///< GPIO Pin Level
    U32 _x_reserved4[1];
    volatile U32 EDS[2];          ///< GPIO Pin Event Detect Status
    U32 _x_reserved5[1];
    volatile U32 REN[2];          ///< GPIO Pin Rising Edge Detect Enable
    U32 _x_reserved6[1];
    volatile U32 FEN[2];          ///< GPIO Pin Falling Edge Detect Enable
    U32 _x_reserved7[1];
    volatile U32 HEN[2];          ///< GPIO Pin High Detect Enable
    U32 _x_reserved8[1];
    volatile U32 LEN[2];          ///< GPIO Pin Low Detect Enable
    U32 _x_reserved9[1];
    volatile U32 AREN[2];         ///< GPIO Pin Async. Rising Edge
    U32 _x_reserved10[1];
    volatile U32 AFEN[2];         ///< GPIO Pin Async. Falling Edge
    U32 _x_reserved11[1];
    volatile U32 PUD;             ///< GPIO Pin Pull-up/down Enable
    volatile U32 PUDCLK[2];       ///< GPIO Pin Pull-up/down Enable Clock
} bcm2835_GPIO;

COMPILE_ASSERT(offsetof(bcm2835_GPIO, FSEL) == BCM2835_GPFSEL0, gpio_fsel_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, SET) == BCM2835_GPSET0, gpio_set_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, CLR) == BCM2835_GPCLR0, gpio_clr_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, LEV) == BCM2835_GPLEV0, gpio_lev_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, EDS) == BCM2835_GPEDS0, gpio_eds_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, REN) == BCM2835_GPREN0, gpio_ren_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, FEN) == BCM2835_GPFEN0, gpio_fen_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, HEN) == BCM2835_GPHEN0, gpio_hen_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, LEN) == BCM2835_GPLEN0, gpio_len_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, AREN) == BCM2835_GPAREN0, gpio_aren_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, AFEN) == BCM2835_GPAFEN0, gpio_afen_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, PUD) == BCM2835_GPPUD, gpio_pud_offset);
COMPILE_ASSERT(offsetof(bcm2835_GPIO, PUDCLK) == BCM2835_GPPUDCLK0, gpio_pudclk_offset);
...
typedef struct
{
    volatile U32 CS;     ///< System Timer Control/Status
    volatile U32 CLO;    //!< ///< System Timer Counter Lower 32 bits
    volatile U32 CHI;    ///< System Timer Counter Upper 32 bits
} bcm2835_ST;
...
typedef struct
{
    ...
    volatile U32 STATUS;
    volatile U32 DMAC;
    volatile U32 _x_reserved_1;
    volatile U32 PWM0_RANGE;
    volatile U32 PWM0_DATA;
    volatile U32 PWM0_FIF1;
    volatile U32 _x_reserved_2;
} bcm2835_PWM;
...
#define BCM2835_ST          ((volatile bcm2835_ST*) BCM2835_ST_BASE)

/// Base of the GPIO registers.
/// Available after bcm2835_init has been called
#define BCM2835_GPIO        ((volatile bcm2835_GPIO*) BCM2835_GPIO_BASE)

/// Base of the PWM registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_pwm;

/// Base of the CLK registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_clk;

/// Base of the PADS registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_pads;

/// Base of the SPI0 registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_spi0;

/// Base of the BSC0 registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_bsc0;

/// Base of the BSC1 registers.
/// Available after bcm2835_init has been called
//extern volatile U32* bcm2835_bsc1;
...
//extern void bcm2835_set_debug(U8 debug);
...
extern U8 bcm2835_gpio_lev(U8 pin);
...
extern U8 bcm2835_gpio_eds(U8 pin);

/// Sets the Event Detect Status register for a given pin to 1,
/// which has the effect of clearing the flag. Use this afer seeing
/// an Event Detect Status on the pin.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_set_eds(U8 pin);
...
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_ren(U8 pin);

/// Disable Rising Edge Detect Enable for the specified pin.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_clr_ren(U8 pin);
...
/// has the effect of suppressing glitches.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_fen(U8 pin);

/// Disable Falling Edge Detect Enable for the specified pin.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_clr_fen(U8 pin);
...
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_aren(U8 pin);

/// Disable Asynchronous Rising Edge Detect Enable for the specified pin.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_clr_aren(U8 pin);
...
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_afen(U8 pin);

/// Disable Asynchronous Falling Edge Detect Enable for the specified pin.
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
extern void bcm2835_gpio_clr_afen(U8 pin);
...
extern void bcm2835_gpio_pud(U8 pud);
...
/// \sa bcm2835_gpio_set_pud()
extern void bcm2835_gpio_pudclk(U8 pin, U8 on);
...
extern U32 bcm2835_gpio_pad(U8 group);
...
extern void bcm2835_gpio_set_pad(U8 group, U32 control);
...
//extern void bcm2835_delayMicroseconds(U64 micros);

/// Sets the output state of the specified pin
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
/// \param[in] on HIGH sets the output to HIGH and LOW to LOW.
extern void bcm2835_gpio_write(U8 pin, U8 on);
...
/// \param[in] on HIGH sets the output to HIGH and LOW to LOW.
//extern void bcm2835_gpio_write_multi(U32 mask, U8 on);
...
/// \param[in] mask Mask of pins to affect. Use eg: (1 << RPI_GPIO_P1_03) | (1 << RPI_GPIO_P1_05)
//extern void bcm2835_gpio_write_mask(U32 value, U32 mask);

/// Sets the Pull-up/down mode for the specified pin. This is more convenient than
/// clocking the mode in with bcm2835_gpio_pud() and bcm2835_gpio_pudclk().
/// \param[in] pin GPIO number, or one of RPI_GPIO_P1_* from \ref RPiGPIOPin.
/// \param[in] pud The desired Pull-up/down mode. One of BCM2835_GPIO_PUD_* from bcm2835PUDControl
extern void bcm2835_gpio_set_pud(U8 pin, U8 pud);
...
extern void bcm2835_spi_setBitOrder(U8 order);
...
extern void bcm2835_spi_setClockDivider(U16 divider);

/// Sets the SPI data mode
/// Sets the clock polariy and phase
/// \param[in] mode The desired data mode, one of BCM2835_SPI_MODE*,
/// see \ref bcm2835SPIMode
extern void bcm2835_spi_setDataMode(U8 mode);
...
extern void bcm2835_spi_chipSelect(U8 cs);
...
extern void bcm2835_spi_setChipSelectPolarity(U8 cs, U8 active);
...
extern U8 bcm2835_spi_transfer(U8 value);
...
extern void bcm2835_spi_transfernb(const U8* tbuf, U8* rbuf, U32 len);
...
/// \sa bcm2835_spi_transfer()
extern void bcm2835_spi_transfern(U8* buf, U32 len);
...
extern void bcm2835_spi_writenb(const U8* buf, U32 len);
...
extern U8 bcm2835_i2c_write(const U8* buf, U32 len);
...
/// \return reason see \ref bcm2835I2CReasonCodes
extern U8 bcm2835_i2c_read(U8* buf, U32 len);
...
/// \param[in] len Number of bytes in the buf buffer, and the number of bytes to received.
/// \return reason see \ref bcm2835I2CReasonCodes
extern U8 bcm2835_i2c_read_register_rs(const U8* regaddr, U8* buf, U32 len);
...
/// \return reason see \ref bcm2835I2CReasonCodes
extern U8 bcm2835_i2c_write_read_rs(const U8* cmds, U32 cmds_len, U8* buf, U32 buf_len);
...
extern U64 bcm2835_st_read(void);

/// Delays for the specified number of microseconds with offset.
/// \param[in] offset_micros Offset in microseconds
/// \param[in] micros Delay in microseconds
extern void bcm2835_st_delay(U64 offset_micros, U64 micros);
...
extern void bcm2835_pwm_set_clock(U32 divisor);
...
extern void bcm2835_pwm_set_mode(U8 channel, U8 markspace, U8 enabled);
...
extern void bcm2835_pwm_set_range(U8 channel, U32 range);
...
extern void bcm2835_pwm_set_data(U8 channel, U32 data);
